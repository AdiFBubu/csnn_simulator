 ...
 */
FaceEllipseConvolution3D::FaceEllipseConvolution3D() : Layer4D(_register),
 ...
 */
size_t FaceEllipseConvolution3D::train_pass_number() const
{
...
void FaceEllipseConvolution3D::process_train_sample(const std::string &label, Tensor<float> &sample, size_t current_pass, size_t current_index, size_t number)
{
	// The training
	if (current_index == 0)
	{
...
void FaceEllipseConvolution3D::process_test_sample(const std::string &label, Tensor<float> &sample, size_t current_index, size_t number)
{
	if (current_index == 0)
	{
...
void FaceEllipseConvolution3D::train(const std::string &label, const std::vector<Spike> &input_spike, const Tensor<Time> &input_time, std::vector<Spike> &output_spike)
{
	_impl.train(label, input_spike, input_time, output_spike);
}

void FaceEllipseConvolution3D::test(const std::string &, const std::vector<Spike> &input_spike, const Tensor<Time> &input_time, std::vector<Spike> &output_spike)
{
	_impl.test(input_spike, input_time, output_spike);
}

void FaceEllipseConvolution3D::on_epoch_end()
{
	_lr_th *= _annealing;
...
Tensor<float> FaceEllipseConvolution3D::reconstruct(const Tensor<float> &t) const
{
	size_t ki = 1;
...
Tensor<float> FaceEllipseConvolution3D::construct_features(const Tensor<float> &t) const
{
	size_t output_width = t.shape().dim(0);
	size_t output_height = t.shape().dim(1);
	size_t output_depth = t.shape().dim(2);
...
#ifdef ENABLE_QT
void FaceEllipseConvolution3D::plot_threshold(bool only_in_train)
{
	add_plot<plot::Threshold>(only_in_train, _th);
}

void FaceEllipseConvolution3D::plot_evolution(bool only_in_train)
{
...
_priv::FaceEllipseConvolution3DImpl::FaceEllipseConvolution3DImpl(FaceEllipseConvolution3D &model) : _model(model), _a(), _inh(), _wta()
{
}

void _priv::FaceEllipseConvolution3DImpl::resize()
{
...
void _priv::FaceEllipseConvolution3DImpl::train(const std::vector<Spike> &input_spike, const Tensor<Time> &input_time, std::vector<Spike> &)
{
...
void _priv::FaceEllipseConvolution3DImpl::test(const std::vector<Spike> &input_spike, const Tensor<Time> &, std::vector<Spike> &output_spike)
{
	size_t depth = _model.depth();
	Tensor<float> &w = _model._w;
	Tensor<float> &th = _model._th;
...
#else
_priv::FaceEllipseConvolution3DImpl::FaceEllipseConvolution3DImpl(FaceEllipseConvolution3D &model) : _model(model), _a(), _inh()
{
}
...
void _priv::FaceEllipseConvolution3DImpl::train(const std::string &label, const std::vector<Spike> &input_spike, const Tensor<Time> &input_time,
									 std::vector<Spike> &output_spike)
{
	this->_label = label;
...
void _priv::FaceEllipseConvolution3DImpl::train(const std::vector<Spike> &input_spike, const Tensor<Time> &input_time, std::vector<Spike> &output_spike)
{
